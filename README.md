# rzstd
Facebook ZSTD Implementation in rust


## Goals:

* As fast or faster than c implementation
* Providing zstd in memory safe language using rust
* Supporting more architectures and easier compilation using rust llvm
